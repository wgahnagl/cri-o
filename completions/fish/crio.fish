...
complete -c crio -n '__fish_crio_no_subcommand' -l container-ulimit-profile -r -d 'Path to the ulimit profile to be used as the runtime\'s default. If not specified, then the internal default seccomp profile will be used. (default: "")'
